package com.curry.vod.service.impl;
...
public class VodServiceImpl implements VodService {
        ...
        try {
            ...
            if (!response.isSuccess()) {
                ...
                if(!StringUtils.hasLength(videoId)){
                    throw new KuliException(20001, errorMessage);
                }
            }

            return videoId;
        } catch (IOException e) {
            throw new KuliException(20001, "guli vod 服务上传失败");
        }
    }
    ...
    public void removeVideo(String videoId) {
        try{
            ...
            throw new KuliException(20001, "视频删除失败");
        }
    }
